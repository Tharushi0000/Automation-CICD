...
public class BaseTest {
	...
	public WebDriver initializeDriver() throws IOException
	{
		...
		FileInputStream fis=new FileInputStream(System.getProperty("user.dir")
				+"//src//main//java//Package1//Resources//GlobalData.properties"); 
		prop.load(fis);
		...
		{
			System.getProperty("webdriver.gecko.driver","C:\\Users\\DELL\\Downloads\\geckodriver-v0.35.0-win-aarch64");
